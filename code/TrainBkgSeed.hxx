//Code generated automatically by TMVA for Inference of Model file [TrainBkgSeed.h5] at [Fri Sep  8 18:19:19 2023] 

#ifndef TMVA_SOFIE_TRAINBKGSEED
#define TMVA_SOFIE_TRAINBKGSEED
...
namespace TMVA_SOFIE_TrainBkgSeed{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "TrainBkgSeed.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_TrainBkgSeed

#endif  // TMVA_SOFIE_TRAINBKGSEED
